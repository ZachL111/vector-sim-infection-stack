...
`vector-sim-infection-stack` is centered on simulations work in C#. The technical target is: Create a C# reference implementation for infection workflows, centered on resource planning, capacity fixtures, and allocation and spill reports.
