"""Regression checks for the vector-sim-infection-stack casebook."""
...
from casebook.harness import assert_expected, vector_sim_infection_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(vector_sim_infection_stack_summary(), assert_expected())
